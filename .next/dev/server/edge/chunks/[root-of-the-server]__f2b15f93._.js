...
async function middleware(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://fojofteguyrwwgqkmhlf.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZvam9mdGVndXlyd3dncWttaGxmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDY3MTMxNjcsImV4cCI6MjA2MjI4OTE2N30.tlLsTjjA0yv6cnGQNLR-7zK9Rpxpmosw4R5ND4JPnZI"), {
        cookies: {
            getAll () {
    ...
    if (isAuthPath && user) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/dashboard', request.url)) // Default logged-in home
        ;
    }
    return response;
}
