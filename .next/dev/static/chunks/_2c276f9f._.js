...
async function isRegistrationComplete(userId) {
    try {
        ...
        const { data: profile, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('full_name, blood_group, blood_group_proof_url').eq('id', userId).single();
        if (error) {
...
"[project]/app/(auth)/login/content.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const { signIn, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            const checkUserRegistration = {
                "LoginPage.useEffect.checkUserRegistration": async ()=>{
                    if (user) {
                        console.log('Checking registration for user:', user);
                        try {
                            const isComplete = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRegistrationComplete"])(user.id);
            ...
            }["LoginPage.useEffect.checkUserRegistration"];
...
_s(LoginPage, "Z5st9i16yV2H+PskxCsrHuXI6ug=", false, function() {
    return [
...
//# sourceMappingURL=_2c276f9f._.js.map