...
function AuthProvider({ children }) {
    ...
    const lastProfileFetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const fetchUserProfile = async (userId)=>{
        ...
        try {
            ...
            if (data) {
                ...
                const { data: newProfile, error: createError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert({
                    id: userId,
                ...
                if (createError) {
                    ...
                    if (createError.code === '23505') {
                        ...
                        const { data: existingProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('*').eq('id', userId).single();
                        if (existingProfile) {
    ...
    const updateProfile = async (data)=>{
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').update(data).eq('id', state.user.id);
            if (error) throw error;
            // Refresh user data
...
_s(AuthProvider, "3aXo04Gwj+BGri5Tsf7keaOBB+4=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
//# sourceMappingURL=_57fd84f0._.js.map